...
namespace SiestaFrame.Physics
{
    ...
    {
        public static void StandardCleanup(this Simulation simulation)
        {
        ...
        private static void CleanupBodiesAndShapes(DynamicsWorld world)
        {
            ...
            for (int i = world.NumCollisionObjects - 1; i >= 0; i--)
            {
                ...
                CleanupBodiesAndShapes(world, obj, shapes);
            }
        ...
        public static void CleanupBodiesAndShapes(DynamicsWorld world, CollisionObject obj, HashSet<CollisionShape> shapes)
        {
