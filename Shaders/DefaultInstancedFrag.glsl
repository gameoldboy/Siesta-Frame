...
#define _NormalScale SSBOData[InstanceID].NormalScale
uniform sampler2D _NormalMap;
#define _Smoothness SSBOData[InstanceID].Smoothness
#define _Metallic SSBOData[InstanceID].Metallic
uniform sampler2D _MetallicMap;
#define _SpecularColor SSBOData[InstanceID].SpecularColor
uniform sampler2D _SpecularMap;
#define _EmissiveColor SSBOData[InstanceID].EmissiveColor
uniform sampler2D _EmissiveMap;
#define _SelectedColor SSBOData[InstanceID].SelectedColor
#define _OcclusionStrength SSBOData[InstanceID].OcclusionStrength
uniform sampler2D _OcclusionMap;
#define _MatCapColor SSBOData[InstanceID].MatCapColor
